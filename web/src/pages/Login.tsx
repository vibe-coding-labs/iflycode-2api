  ...
  return (
    <div style={{
      ...
      <Tooltip title="去 GitHub Star 支持我们">
        <a
          href="https://github.com/vibe-coding-labs/iflycode-2api"
          target="_blank"
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <Title level={3} style={{ marginBottom: 4 }}>iFlyCode 代理</Title>
          <Text type="secondary">请输入管理密码登录</Text>
        </div>
        <Form onFinish={handleSubmit} size="large">
          ...
          >
            <Input.Password prefix={<LockOutlined />} placeholder="管理密码" autoFocus />
          </Form.Item>
